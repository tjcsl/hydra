...
extern int hydra_read_SUBMIT (int fd,const void** exe_name_data,int *exe_name_len,uint16_t *slots,uint16_t *numfiles,uint32_t *jobid);
extern int hydra_write_SUBMIT(int fd,const void*  exe_name_data,int exe_name_len,uint16_t  slots,uint16_t  numfiles,uint32_t  jobid);
